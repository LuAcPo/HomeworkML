...
def two(data,mask,graph,labels,index_test,temperature):
    path = 'AT'+str(temperature)+'best_val_model.pkl'
...
def main(index_train,index_val,index_test,temperature=2, if_eval=False):
    ...
    model = models.Model2(d_in=data.shape[-1], d_model=8, nclass=7, nh1=8, nh2=8, alpha=0.2, dropout=0.6)
    ...
    for epoch in range(150):
        ...
        if val_acc>best_val_acc:
            ...
            torch.save(model,'AT'+str(temperature)+'best_val_model.pkl')
